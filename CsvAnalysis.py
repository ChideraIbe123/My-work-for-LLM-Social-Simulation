...
class CsvAnalysis:
 def __init__(self, population:int, file_name:str) -> None:
   ...
   head.extend(["GDP", "Daily GDP Growth Rate", "Mean Food", "Median Food", "SD Food", "Richest Food (ID | Amount)",
                    ...
                    "SD Land", "Richest Land (ID | AMount)", "Poorest Land (ID | AMount)", "Gini Land", "Mean Luxury Goods", "Median Luxury Goods", "SD Luxury Goods", "Richest Luxury Goods (ID | Amount)", "Poorest Luxury Goods (ID | Amount)", "Gini Luxury Goods", "Overall Land Mean", "Overall Land Median", "Overall Land Std", "Overall Food Mean", "Overall Food Median", "Overall Food Std", "Overall Luxury Goods Mean", "Overall Luxury Goods Median", "Overall Luxury Goods Std", "Average Luxury Good Production", "Average Food Production", "Good Distribution Ratio (Food/Luxury)", "Trade Initiated Ratio", "Trade Accepted Ratio", 
